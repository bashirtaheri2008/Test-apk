                  ...
                  children: [
                    if (message.forwardedFrom.isNotEmpty)
                      Padding(
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          ...
                          const SizedBox(width: 4),
                          Text('فوروارد از ${message.forwardedFrom}', style: TextStyle(fontSize: 12, color: timeColor, fontStyle: FontStyle.italic)),
                        ]),
                      ),
                    ...
                    Row(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      if (isMe) ...[
                        ...
                        Icon(
                          message.status == MessageStatus.read ? Icons.done_all : message.status == MessageStatus.delivered ? Icons.done_all : Icons.check,
                          size: 14,
                          color: message.status == MessageStatus.read ? const Color(0xFF53bdeb) : timeColor,
                        ),
                      ],
                    ]),
                  ],
