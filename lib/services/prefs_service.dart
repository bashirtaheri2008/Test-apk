...
class PrefsService {
  ...
  static SharedPreferences get _sp {
    if (_prefs == null) throw StateError('Prefs not initialized');
    return _prefs!;
  }
  ...
  static set themeMode(String v) => _sp.setString('themeMode', v);
  static Future<void> logout() async { await _sp?.clear(); _prefs = null; }
}
